...
def toolScal(table):
    ...
    X=pd.read_sql(sql,engine).astype(float)  #class input DF
...
#    print(pca.explained_variance_)
    ...
    X_rob_df.to_sql(name='A01_CCMT060204_EMF_01_condition_scal'.lower(),con=engine,if_exists='replace')
    
    np.savetxt(r'd:\Workplace\408\datas\a01_ccmt060204_emf_01_condition_scal.txt', X_nor, fmt='%.10e',delimiter=',',newline='\r\n')
